...
#' @examples
#' predictAge(bs, adult.age = 20, fastImpute = FALSE, imp = 10, calcArrayClocks = TRUE)
#' @import bsseq
#' @import glmnet
#' @import mice
#' @import impute
...
predictAge <- function(bs, adult.age = 20, fastImpute = FALSE, imp = 10, calcArrayClocks = TRUE) {
    ...
    if ( calcArrayClocks == TRUE) {
        ...
        overlaps <- as.data.frame(findOverlaps(array.gr,beta.gr))
        ...
        dunedin <- DunedinPACE::PACEProjector(beta.subset)
